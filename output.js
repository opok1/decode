//Mon Aug 05 2024 06:45:14 GMT+0000 (Coordinated Universal Time)
...
async function lottery(_0x441184) {
  ...
  var _0x2a6103 = "data=" + encodeURIComponent(JSON.stringify(_0x5e77db));
  const _0x1bf295 = getToken(_0x441184),
    _0x220c48 = _0x1bf295.split("_")[0];
  const _0x26f153 = await sign(_0x220c48 + "&" + _0xa7878d + "&" + _0x50123d + "&" + JSON.stringify(_0x5e77db), kami);
  var _0x348a9a = {
  ...
  return tryCatchPromise(_0x7b3036 => {
    request(_0x348a9a, async (_0x17815a, _0x4074f6, _0x430b29) => {
