//Tue Jul 09 2024 04:33:26 GMT+0000 (Coordinated Universal Time)
...
class Bar {
  ...
  async login() {
    let _0x5c6e3e = Buffer.from(EncryptCrypto("DES", "CBC", "Pkcs7", this.phone, this.deskey, this.deskey), "base64").toString("hex").toUpperCase(),
      _0x3d12d5 = Buffer.from(EncryptCrypto("DES", "CBC", "Pkcs7", this.password, this.deskey, this.deskey), "base64").toString("hex").toUpperCase(),
      _0x55e2f8 = "{\"data\":{\"password\":\"" + _0x3d12d5 + "\",\"loginName\":\"" + _0x5c6e3e + "\"},\"service\":\"core\",\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"api\":\"login/loginByPwd\",\"token\":\"\"} ",
      _0x22e43 = await task("post", "https://app.eyh.cn/gateway/api", {}, _0x55e2f8);
  ...
  async tasklist() {
    let _0x76e9e8 = "{\"service\":\"csintegral\",\"api\":\"/task/queryListByParam.json\",\"data\":{\"classify\":\"EVERY_DAY\",\"content\":\"null\"},\"url\":\"gateway/csintegralApi\",\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x17ab01 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x76e9e8);
    if (_0x17ab01.code == 0) {
  ...
  async signin() {
    let _0x4b3763 = "{\"api\":\"user_integral/userSignIn.json\",\"service\":\"csintegral\",\"data\":{\"userName\":\"\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x905c38 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x4b3763);
    _0x905c38.code == 0 ? console.log("【" + this.phone + "】签到成功") : console.log("【" + this.phone + "】签到失败");
  }
  async like() {
    let _0x32e21b = "4" + SJS(4),
      _0x50d8de = "{\"service\":\"media\",\"api\":\"article/savePraiseLog\",\"data\":{\"articleId\":" + _0x32e21b + ",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x303180 = await task("post", "https://app.eyh.cn/gateway/api", {}, _0x50d8de);
  ...
  async share() {
    let _0x22e8a5 = "4" + SJS(4),
      _0x1ccb7a = "{\"service\":\"media\",\"api\":\"article/saveShareLog\",\"data\":{\"articleId\":" + _0x22e8a5 + ",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x39d7c7 = await task("post", "https://app.eyh.cn/gateway/api", {}, _0x1ccb7a);
  ...
  async comment() {
    let _0x423b45 = "4" + SJS(4),
      _0x5027f8 = "{\"service\":\"media\",\"api\":\"article/saveComment\",\"data\":{\"articleId\":" + _0x423b45 + ",\"content\":\"" + this.word + "\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x2e71cc = await task("post", "https://app.eyh.cn/gateway/api", {}, _0x5027f8);
  ...
  async read() {
    let _0x480ed8 = "4" + SJS(4),
      _0x5de07c = "{\"api\":\"article/queryArticleDetailUnionEncrypt\",\"data\":{\"articleId\":" + _0x480ed8 + "},\"userDevice\":{\"device\":\"ios\",\"deviceId\":\"" + this.did + "\",\"os\":\"16.1\",\"deviceType\":\"iPhone15,2\",\"clientVersion\":\"4.1.2\",\"deviceBrand\":\"iphone\"},\"token\":\"" + this.token + "\",\"service\":\"media\"} ",
      _0x561d11 = await task("post", "https://app.eyh.cn/gateway/api", {}, _0x5de07c);
  ...
  async readtime() {
    let _0x783ee3 = times(13),
      _0x55c265 = "{\"service\":\"csintegral\",\"api\":\"/read_time/insert.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"articleId\":\"" + this.id + "\",\"beginTime\":\"" + (_0x783ee3 - 150000) + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x2a7481 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x55c265);
  ...
  async endreadtime() {
    let _0x1809e2 = times(13),
      _0x31b1e9 = "{\"service\":\"csintegral\",\"api\":\"/read_time/update.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"id\":\"" + this.endid + "\",\"endTime\":\"" + _0x1809e2 + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"} ",
      _0x3b7d21 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x31b1e9);
    _0x3b7d21.message == "用户阅读时长信息修改成功" ? console.log("【" + this.phone + "】阅读时长添加成功") : console.log("【" + this.phone + "】阅读时长添加失败");
  }
  async likesq() {
    let _0x19d008 = "7" + SJS(4),
      _0xb6cfa5 = "{\"service\":\"csintegral\",\"api\":\"user_behavior/insert.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"behavior\":\"PRAISE_POST\",\"articleId\":\"" + _0x19d008 + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"}",
      _0x41c27f = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0xb6cfa5);
  ...
  async rewardcom() {
    let _0x5ace77 = "{\"service\":\"csintegral\",\"api\":\"user_behavior/insert.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"behavior\":\"COMMENT_POST\",\"articleId\":\"" + this.sqid + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi M2011K2C\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"}",
      _0x33831a = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x5ace77);
  ...
  async rewardupdatesq() {
    let _0x4a4ac8 = "{\"service\":\"csintegral\",\"api\":\"user_behavior/insert.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"behavior\":\"COMMUNITY_POSTING\",\"articleId\":\"" + this.sqid + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi M2011K2C\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"}",
      _0x1b3c82 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x4a4ac8);
  ...
  async userinfo() {
    let _0x19057c = "{\"service\":\"csintegral\",\"api\":\"/user_integral/queryInfo.json\",\"url\":\"gateway/csintegralApi\",\"data\":{\"behavior\":\"COMMUNITY_POSTING\",\"articleId\":\"" + this.sqid + "\",\"content\":\"null\"},\"userDevice\":{\"os\":\"11\",\"deviceBrand\":\"Xiaomi\",\"deviceId\":\"" + this.did + "\",\"deviceType\":\"Xiaomi M2011K2C\",\"device\":\"android\",\"clientVersion\":\"4.1.2\"},\"token\":\"" + this.token + "\"}",
      _0x74c1b7 = await task("post", "https://app.eyh.cn/gateway/csintegralApi", {}, _0x19057c);
...
function EncryptCrypto(_0x5f55b4, _0x690944, _0x7bb3f8, _0x43e453, _0x478b76, _0xce0e2a) {
  const _0x3a3c6f = require("crypto-js"),
    _0xb2cd82 = _0x3a3c6f.enc.Utf8.parse(_0x43e453),
    _0x1bd151 = _0x3a3c6f.enc.Utf8.parse(_0xce0e2a),
    _0x3e7f43 = _0x3a3c6f.enc.Utf8.parse(_0x478b76),
    _0x33e5ea = _0x3a3c6f[_0x5f55b4].encrypt(_0xb2cd82, _0x3e7f43, {
      iv: _0x1bd151,
...
function DecryptCrypto(_0x2b156a, _0x4eb462, _0xaabca, _0x265c87, _0x4bf58d, _0x7fecaa) {
  const _0x3fd8c2 = require("crypto-js"),
    _0x3186f5 = _0x3fd8c2.enc.Utf8.parse(_0x7fecaa),
    _0x4f9db5 = _0x3fd8c2.enc.Utf8.parse(_0x4bf58d),
    _0x34b2a9 = _0x3fd8c2[_0x2b156a].decrypt(_0x265c87, _0x4f9db5, {
      iv: _0x3186f5,
...
function SHA256(_0x10afec) {
  ...
  return function (_0x222019) {
    ...
    const _0x57d2b6 = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298],
      _0x5b0c5c = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225],
      _0x3a5699 = new Array(64);
    let _0x114cf7, _0x391bfa, _0x6f7166, _0x112328, _0x32395e, _0x166b10, _0x313d11, _0x56fedd, _0x2f77fb, _0x401261, _0x1be01e, _0x1395e8;
...
function MD5Encrypt(_0x518df1) {
  ...
  function _0x2d2729(_0x5685b8, _0xf86e8d) {
    var _0x321b3d, _0x1cb5ed, _0x40f09e, _0x5491ee, _0x44db1a;
  ...
  function _0x2629e5(_0x3283b8, _0xe5d25d, _0x223fb0, _0x150c91, _0x5773dd, _0x49f186, _0x28d6d5) {
    var _0x287d92, _0x23b070, _0x220e27;
